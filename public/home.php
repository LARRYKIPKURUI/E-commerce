...
<section class="bg-gray-600 body-font">
  <div class="container flex flex-col items-center px-5 py-24 mx-auto md:flex-row">
    <div class="flex flex-col items-center mb-16 text-center lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 md:items-start md:text-left md:mb-0">
      ...
      <a href="about.php">  <button class="inline-flex px-6 py-2 text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">Our Services</button></a>
      <a href="logout.php">  <button class="inline-flex px-6 py-2 ml-4 text-lg text-white bg-gray-900 border-0 rounded focus:outline-none hover:bg-gray-700 hover:text-white">Log out</button> </a>
      </div>
    </div>
