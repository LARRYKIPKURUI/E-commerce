...
<div class="font-[sans-serif] bg-gray-500">
    <div class="p-4 mx-auto lg:max-w-7xl sm:max-w-full">
      <h2 class="mb-12 text-4xl font-extrabold text-gray-800">Premium Sneakers</h2>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-xl:gap-4">
        <div class="relative p-5 transition-all bg-white cursor-pointer rounded-2xl hover:-translate-y-2">
          <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="18px" class="inline-block fill-gray-800" viewBox="0 0 64 64">
              <path
          ...
          <div>
            ...
            <h4 class="mt-4 text-lg font-bold text-gray-800">$10</h4>
            <button type="button"
            class="px-4 ml-12 py-2.5 rounded text-white text-sm tracking-wider font-semibold border-none outline-none bg-purple-600 hover:bg-purple-700 active:bg-purple-600">
            <svg xmlns="http://www.w3.org/2000/svg" width="16px" fill="#fff" class="inline mr-2" viewBox="0 0 24 24">
              <path
        ...
        <div class="relative p-5 transition-all bg-white cursor-pointer rounded-2xl hover:-translate-y-2">
          ...
          <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <h4 class="mt-4 text-lg font-bold text-gray-800">$12</h4>
            <button type="button"
            class="px-4 ml-12 py-2.5 rounded text-white text-sm tracking-wider font-semibold border-none outline-none bg-purple-600 hover:bg-purple-700 active:bg-purple-600">
            <svg xmlns="http://www.w3.org/2000/svg" width="16px" fill="#fff" class="inline mr-2" viewBox="0 0 24 24">
              <path
        ...
        <div class="relative p-5 transition-all bg-white cursor-pointer rounded-2xl hover:-translate-y-2">
          ...
          <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <h4 class="mt-4 text-lg font-bold text-gray-800">$14</h4>
            <button type="button"
            class="px-4 ml-12 py-2.5 rounded text-white text-sm tracking-wider font-semibold border-none outline-none bg-purple-600 hover:bg-purple-700 active:bg-purple-600">
            <svg xmlns="http://www.w3.org/2000/svg" width="16px" fill="#fff" class="inline mr-2" viewBox="0 0 24 24">
              <path
        ...
        <div class="relative p-5 transition-all bg-white cursor-pointer rounded-2xl hover:-translate-y-2">
          ...
          <div>
            ...
            <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <h4 class="mt-4 text-lg font-bold text-gray-800">$15</h4>
            <button type="button"
            class="px-4 ml-12 py-2.5 rounded text-white text-sm tracking-wider font-semibold border-none outline-none bg-purple-600 hover:bg-purple-700 active:bg-purple-600">
            <svg xmlns="http://www.w3.org/2000/svg" width="16px" fill="#fff" class="inline mr-2" viewBox="0 0 24 24">
              <path
