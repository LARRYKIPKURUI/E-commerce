...
<!-- Contact Us-->
<section class="relative text-white bg-gray-600 body-font">
  <div class="container flex flex-wrap px-5 py-24 mx-auto sm:flex-nowrap">
    <div class="relative flex items-end justify-start p-10 overflow-hidden bg-gray-900 rounded-lg lg:w-2/3 md:w-1/2 sm:mr-10">
      <h1 class="p-4 mr-4 text-2xl text-white">Route Map to our Shoe Hub Store</h1>
      <iframe width="100%" height="100%" title="map" class="absolute inset-0" frameborder="0" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d498.601860265313!2d36.82882211302694!3d-1.285036585036392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2ske!4v1714498378031!5m2!1sen!2ske" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" style="filter: grayscale(1) contrast(1.2) opacity(0.16);"></iframe>
      <div class="relative flex flex-wrap py-6 bg-gray-900 rounded shadow-md">
        <div class="px-6 lg:w-1/2">
          <h2 class="text-xs font-semibold tracking-widest text-white title-font">ADDRESS</h2>
          <p class="mt-1">Ronald Ngala Street Opposite RNG Plaza</p>
        </div>
        <div class="px-6 mt-4 lg:w-1/2 lg:mt-0">
          <h2 class="text-xs font-semibold tracking-widest text-white title-font">EMAIL</h2>
          <a class="leading-relaxed text-indigo-400">larry@gmail.com</a>
          <h2 class="mt-4 text-xs font-semibold tracking-widest text-white title-font">PHONE</h2>
          <p class="leading-relaxed">0742009797</p>
        </div>
      </div>
    </div>
...
<!-- FAQ -->
<div class="bg-white px-6 font-[sans-serif] flex flex-col items-center p-5">
  <h2 class="mb-10 text-3xl font-extrabold text-indigo-700">Frequently Asked Questions</h2>
  <div class="max-w-4xl space-y-8">
    <div class="flex items-start">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]">How can I track my order on Shoe Hub?</h3>
        <p class="text-sm text-[#333] mt-4">Once your order is processed and shipped, you'll receive a tracking number via email. Simply enter the tracking number on our website's tracking page to monitor your package's journey right to your doorstep.</p>
      </div>
    </div>
    <div class="flex items-start">
      <div class="flex-shrink-0">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]">What is Shoe Hub's return policy?</h3>
        <p class="text-sm text-[#333] mt-4">We understand that finding the perfect fit is essential. That's why we offer a hassle-free return policy. If you're not completely satisfied with your purchase, you can return it within 30 days for a full refund or exchange. Just make sure the item is unworn and in its original condition.</p>
      </div>
    </div>
    <div class="flex items-start">
      <div class="flex-shrink-0">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]"> Does Shoe Hub offer international shipping?</h3>
        <p class="text-sm text-[#333] mt-4">Yes, we ship globally! Whether you're located in the heart of the city or across the ocean, we'll deliver your order to you. Please note that international shipping rates and delivery times may vary depending on your location.</p>
      </div>
    </div>
    <div class="flex items-start">
      <div class="flex-shrink-0">
      ...
      <div class="ml-4">
        <h3 class="text-lg font-semibold text-[#333]">Are the shoes on Shoe Hub authentic?</h3>
        <p class="text-sm text-[#333] mt-4">Absolutely! We take pride in offering only authentic footwear from trusted brands. Each pair of shoes on Shoe Hub is sourced directly from authorized distributors and comes with our authenticity guarantee. Shop with confidence knowing you're getting the real deal.</p>
      </div>
    </div>
  </div>
</div>
