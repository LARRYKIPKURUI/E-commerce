...
<div class="font-[sans-serif] bg-white p-4">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="mt-12">
          ...
          <div class="grid gap-6 mt-16 mb-5 md:grid-cols-3">
            <div>
            ...
            <div class="md:col-span-2">
              <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="flex items-center">
                 <!-- <input type="checkbox" class="cursor-pointer h-17 w-9" id="mpesa" /> -->
                  <label for="paypal" class="flex gap-2 ml-4 cursor-pointer ">
                    <img src="images/mpesa.png" class=" w-28.5" alt="Mpesa Icon" />
                  </label>
                </div>
              </div>
              <div class="grid gap-6 mt-6 sm:grid-cols-5">
                <div class="col-span-2">
                  <input type="number" placeholder="Amount in Kshs"
                    class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-2 rounded-md focus:border-blue-500 outline-none" />
                </div>
                <div class="col-span-2">
                  <input type="number" placeholder="Phone Number"
                    class="px-2 py-3.5 bg-white text-[#333] w-full text-sm border-2 rounded-md focus:border-blue-500 outline-none" />
                </div>
            </div>
          </div>
          <div class="float-left">
            ...
            <button type="button"
              class="px-6 py-3.5 text-sm bg-blue-600 text-white rounded-md hover:bg-blue-700">Pay now</button>
          </div>
        </div>
      </div>
</div>
