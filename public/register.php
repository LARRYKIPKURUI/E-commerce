<?php
   ...
   if (empty($username)) {
       ...
       $username_error = "Username should have at least 3 characters";
   ...
   if (empty($confirmpassword)) {
       ...
       $confirmpassword_error = "Password and Confirmed Password must match";
   }
...
<section class="pb-5 text-gray-400 bg-gray-800 body-font">
  <div class="container flex flex-wrap items-center px-5 mx-auto py-18 ">
      ...
      <div class="flex flex-col w-full p-8 bg-opacity-50 rounded-lg bg-9 gray-800 mt- lg:w-2/5 md:w-1/2 md:ml-auto md:mt-0">
        <form action="<?php  echo $_SERVER['PHP_SELF']; ?>" method="post" >
          ...
          <div class="relative ">
            ...
            <p class="error" style="color: red;"><?php echo $email_error; ?></p><br> 
          </div>
          <div class="relative ">
            <label for="email" class="text-sm leading-7 text-gray-400">Password</label>
            <input type="password" id="password" name="password" class="w-full px-3 py-1 text-base leading-8 text-gray-100 transition-colors duration-200 ease-in-out bg-gray-600 border border-gray-600 rounded outline-none bg-opacity-20 focus:bg-transparent focus:ring-2 focus:ring-indigo-900 focus:border-indigo-500">
          ...
          <div class="relative ">
            ...
            <input type="password" id="confirm_password" name="confirmpassword" class="w-full px-3 py-1 text-base leading-8 text-gray-100 transition-colors duration-200 ease-in-out bg-gray-600 border border-gray-600 rounded outline-none bg-opacity-20 focus:bg-transparent focus:ring-2 focus:ring-indigo-900 focus:border-indigo-500">
            <p class="error" style="color: red;"><?php echo $confirmpassword_error; ?></p><br> 
          </div>
          <button name="submit" class="px-8 py-2 text-lg text-white bg-indigo-500 border-0 rounded focus:outline-none hover:bg-indigo-600">Sign Up</button>
          <p class="mt-3 text-xs">If you already have an account, <a href="index.php" class="text-indigo-400">Login here</a>.</p>
        </form>
        </div>
